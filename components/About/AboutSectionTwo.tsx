        ...
        <div className="relative border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div
                className={`relative mx-auto my-16 lg:my-0 ${vertOrHoriz(sizeImage.width, sizeImage.height)}`}
              >
                {
                  ...
                  moreDetails?.titles?.map((item, index) => {
                    return (
                      <div className="mb-9" key={index}>
                        <h3 className="mb-4 text-xl font-bold text-black dark:text-white opacity-80 sm:text-2xl lg:text-xl xl:text-2xl">
                          {item}
                        </h3>
